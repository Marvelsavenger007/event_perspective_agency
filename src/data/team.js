...
export const hods = [
  ...
  },
  {
    ...
    image: omotayo,
    tagline: "Everyday Holds it’s own opportunity find it",
    drive: "She is driven by the desire to create financial stability, operational excellence, and lasting organizational value through disciplined leadership, continuous improvement, and impactful results.",
    zeal: "Omotayo bring passion, energy, and a proactive mindset to finance and administrative leadership. she view every process as an opportunity to improve efficiency, strengthen controls, and create value. Commitment  to build seamless operations that empower people, support strategic goals, and drive organizational excellence.",
    determination: "Omotayo lead with an ownership mindset, unwavering integrity, and a commitment to excellence. She thrives under pressure, ensuring financial accuracy, operational efficiency, and disciplined resource management. By proactively solving challenges and streamlining processes, Omotayo keep's the organization financially sound and operationally effective while consistently delivering results.",
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/afolabi-omotayo/",
      },
    ],
  },
  {
    ...
    zeal: "Mariam is passionaate about transforming scattered field data into clear, decision-ready reports. She has built performance dashboards and franchise-level tracking that give clients ful visibility into what is working .",
    determination: "While managing client relationships across multiple live accounts, Mariam consistently delivers without compromise. She keeps every project moving forward, every detail in check, and every committment on track. No loose ends. No dropped balls. Just results.",
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/mariam-omosalewa-olaleye-9ab603212/",
      },
    ],
  },
  {
...
export const admin = [
  {
    id: "tm-1",
    name: "Osuntoki Victoria",
    role: "Accounting",
    image: tohrea,
    tagline: "Driven by accuracy, guided by integrity, and committed to excellence",
    drive: "Victoria is driven by a commitment to financial accuracy, accountability, and organizational efficiency. She takes pride in ensuring that financial processes are well-managed, reliable, and aligned with the organization’s goals.",
    zeal: "She brings a positive and dedicated approach to her responsibilities, with a willingness to learn, improve, and contribute meaningfully to the team. Her enthusiasm for her work is reflected in her attention to detail and commitment to maintaining high professional standards.",
    determination: "Victoria is determined to consistently deliver accurate and timely results while maintaining integrity and professionalism. She approaches challenges with focus and resilience, always seeking effective solutions and opportunities for continuous improvement",
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/kanbi-owolabi-447a3846/",
  ...
  {
    id: "tm-2",
    name: "Raphael Oluwatosin Grace",
    role: "Administration / Front Desk",
    image: grace,
    tagline: "Dependable in execution, approachable in collaboration, and committed to getting the job done.",
    drive: "Growth, excellence and the desire to make a meaningful impact",
    zeal: "To keep learning, improving, and giving my best in everything i do.",
    determination: "To overcome challenges, achieve my goals and never give up until i get the desired result.",
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/kanbi-owolabi-447a3846/",
...
export const clientServices = [
  {
    ...
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/toyosi-odutola-2ba999284",
      },
    ],
  },
  {
    id: "tm-1",
    name: "Adebola Agbeniyi",
    role: "Client Service",
    image: bola,
...
export const operations = [
  ...
  {
    id: "tm-2",
    name: "Elaiho Adesuwa Confidence",
    role: "Operations Officer",
    image: null,
    tagline: "Every event is a film, and every guest is the audience.",
    drive: "Confidence is driven by the desire to turn challenges into results, bring structure where there is chaos,  and leave every task, team and environment better than she found it",
    zeal: "Confidence zeal is to keep growing, keep pushing and keep becoming better, never settling for ordinary when she knows she is capable of extraordinary.",
    determination: "Confidence may face obstacles, but she refuses to let them define her outcome. she keeps pushing until the job is done and the goal is achieved.",
    socials: [
      {
        icon: FaLinkedin,
        url: "https://www.linkedin.com/in/kanbi-owolabi-447a3846/",
...
export const officeSpaces = [
  { label: "Executive Office", image: space1, span: true },
  { label: "Creative Studio", image: space1, },
  { label: "Receptionist Suite", image: space2, },
  { label: "Client Boardroom", image: space4, },
  { label: "Production Workshop", image: office, },
];